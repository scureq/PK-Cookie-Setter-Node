 ...
 * @since AM 5.5.0
 */
public class CoookieSetterNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(CoookieSetterNodePlugin.currentVersion, 
				Collections.singletonList(CoookieSetterNode.class));
	}
	...
	public String getPluginVersion() {
		return CoookieSetterNodePlugin.currentVersion;
	}
}
